...
void change_number(int& hour, int& minutes, int& original_hour, char& day_night);//calculating the changes
...
int main()
{
    ...
    do
    {
        ...
        change_number(hour, minutes, original_hour, day_night);//convert function call
...
void change_number(int& hour, int& minutes, int& original_hour, char& day_night)//converting the number
{
