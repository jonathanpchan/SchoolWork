/**************************************
Project:Base Addition

Author: Jonathan Chan

Description:This program uses arrays to add numbers of any base

Notes: 1/13/2013 Did the whole project. Had trouble with reversing. Adding was okay had troubles finding a solution for nice formatting. Ended up filling arrays with 0s
       1/23/2013 Changed BaseToNum and NumToBase to return int/char respectively
       1/24/2013 Fixed other functions to work with the new returns, added a padding function.
       1/27/2013 changed to pointers
**************************************/
...
int main()
{
    ...
    baseNum1 = new char[MAX];
    baseNum2 = new char[MAX];
    baseSol = new char[MAX];


    strcpy(baseNum1, "101010101");
    strcpy(baseNum2, "10101");
    cout <<"Base" << BASE << endl;
